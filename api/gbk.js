...
<head data-suburl="">
	...
	<title>Yoursmile7/TVBox: All content is for learning only, please do not use it for illegal purposes. - js/lib/gbk.js at master - Agit</title>
...
<div class="right stackable menu header-right">
	...
	<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fYoursmile7%2fTVBox%2fsrc%2fbranch%2fmaster%2fjs%2flib%2fgbk.js">
...
<div id="repoHome" class="repository file list ">
		...
		<div class="repo-header">
			...
			<svg viewBox="0 0 16 16" class="svg octicon-repo" width="32" height="32" aria-hidden="true"><path fill-rule="evenodd" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z"/></svg>
				...
				<div class="repo-buttons">
					<form method="post" action="/Yoursmile7/TVBox/action/watch?redirect_to=%2fYoursmile7%2fTVBox%2fsrc%2fbranch%2fmaster%2fjs%2flib%2fgbk.js">
					...
					<form method="post" action="/Yoursmile7/TVBox/action/star?redirect_to=%2fYoursmile7%2fTVBox%2fsrc%2fbranch%2fmaster%2fjs%2flib%2fgbk.js">
						<input type="hidden" name="_csrf" value="ygSs7KcUXfe_IIVCLnRNbRKBYOs6MTcwNDk2MTQwMDgyNTYyMTYzNw">
	...
	<div class="ui floating filter dropdown custom" data-can-create-branch="false" data-no-results="未找到结果">
		...
		<div class="data" style="display: none" data-mode="branches">
				...
				<div class="item branch selected" data-url="/Yoursmile7/TVBox/src/branch/master/js/lib/gbk.js">master</div>
					...
					<span class="ui breadcrumb repo-path">
						<a class="section" href="/Yoursmile7/TVBox/src/branch/master" title="TVBox">TVBox</a>
							...
							<span class="divider">/</span>
								...
								<span class="active section" title="gbk.js">gbk.js</span>
		...
		<div class="file-header-right df ac">
			<div class="ui right file-actions">
				<div class="ui buttons">
					<a class="ui button" href="/Yoursmile7/TVBox/raw/branch/master/js/lib/gbk.js">原始文件</a>
					
						<a class="ui button" href="/Yoursmile7/TVBox/src/commit/fba2258c9cb102b1a318000bf3f829b2e334fe10/js/lib/gbk.js">永久链接</a>
					
					
						<a class="ui button" href="/Yoursmile7/TVBox/blame/branch/master/js/lib/gbk.js">Blame</a>
					
					<a class="ui button" href="/Yoursmile7/TVBox/commits/branch/master/js/lib/gbk.js">文件历史</a>
				</div>
					...
					<tbody>
						...
						<tr>
							...
							<td rel="L2" class="lines-code chroma">
								<code></span><span class="cm"> * gbk编码解码函数</code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma">
								<code></span><span class="cm"> * strTool = gbkTool() strTool.encode(key)</code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L4" class="lines-code chroma">
								<code></span><span class="cm"> * @returns {{encode: (function(*): *), decode: (function(*): *)}}</code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L6" class="lines-code chroma">
								<code><span class="kr">export</span> <span class="kd">function</span> <span class="nx">gbkTool</span><span class="p">(</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L7" class="lines-code chroma">
								<code>    <span class="kd">var</span> <span class="nx">data</span><span class="o">=</span><span class="kd">function</span><span class="p">(</span><span class="nx">zipData</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L8" class="lines-code chroma">
								<code>            <span class="kd">var</span> <span class="nx">re</span><span class="o">=</span><span class="nx">zipData</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L9" class="lines-code chroma">
								<code>                <span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/#(\d+)\$/g</span><span class="p">,</span><span class="kd">function</span><span class="p">(</span><span class="nx">a</span><span class="p">,</span><span class="nx">b</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L10" class="lines-code chroma">
								<code>                    <span class="k">return</span> <span class="nb">Array</span><span class="p">(</span><span class="o">+</span><span class="nx">b</span><span class="o">+</span><span class="mi">3</span><span class="p">)</span><span class="p">.</span><span class="nx">join</span><span class="p">(</span><span class="s1">&#39;#&#39;</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L12" class="lines-code chroma">
								<code>                <span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/#/g</span><span class="p">,</span><span class="s1">&#39;####&#39;</span><span class="p">)</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L13" class="lines-code chroma">
								<code>                <span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/(\w\w):([\w#]+)(?:,|$)/g</span><span class="p">,</span><span class="kd">function</span><span class="p">(</span><span class="nx">a</span><span class="p">,</span><span class="nx">hd</span><span class="p">,</span><span class="nx">dt</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L14" class="lines-code chroma">
								<code>                    <span class="k">return</span> <span class="nx">dt</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/../g</span><span class="p">,</span><span class="kd">function</span><span class="p">(</span><span class="nx">a</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L15" class="lines-code chroma">
								<code>                        <span class="k">if</span><span class="p">(</span><span class="nx">a</span><span class="o">!=</span><span class="s1">&#39;##&#39;</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L16" class="lines-code chroma">
								<code>                            <span class="k">return</span> <span class="nx">hd</span><span class="o">+</span><span class="nx">a</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L18" class="lines-code chroma">
								<code>                            <span class="k">return</span> <span class="nx">a</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L22" class="lines-code chroma">
								<code>            <span class="k">return</span> <span class="nx">re</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L24" class="lines-code chroma">
								<code>        <span class="nx">U2Ghash</span><span class="o">=</span><span class="p">{</span><span class="p">}</span><span class="p">,</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L25" class="lines-code chroma">
								<code>        <span class="nx">G2Uhash</span><span class="o">=</span><span class="p">{</span><span class="p">}</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L26" class="lines-code chroma">
								<code>    <span class="o">!</span><span class="kd">function</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L27" class="lines-code chroma">
								<code>        <span class="kd">var</span> <span class="nx">k</span><span class="o">=</span><span class="mi">0</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L28" class="lines-code chroma">
								<code>        <span class="nx">data</span><span class="o">=</span><span class="nx">data</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="sr">/..../g</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L29" class="lines-code chroma">
								<code>        <span class="k">for</span><span class="p">(</span><span class="kd">var</span> <span class="nx">i</span><span class="o">=</span><span class="mh">0x81</span><span class="p">;</span><span class="nx">i</span><span class="o">&lt;=</span><span class="mh">0xfe</span><span class="p">;</span><span class="nx">i</span><span class="o">++</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L30" class="lines-code chroma">
								<code>            <span class="k">for</span><span class="p">(</span><span class="kd">var</span> <span class="nx">j</span><span class="o">=</span><span class="mh">0x40</span><span class="p">;</span><span class="nx">j</span><span class="o">&lt;=</span><span class="mh">0xFE</span><span class="p">;</span><span class="nx">j</span><span class="o">++</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L31" class="lines-code chroma">
								<code>                <span class="nx">U2Ghash</span><span class="p">[</span><span class="nx">data</span><span class="p">[</span><span class="nx">k</span><span class="o">++</span><span class="p">]</span><span class="p">]</span><span class="o">=</span><span class="p">(</span><span class="s1">&#39;%&#39;</span><span class="o">+</span><span class="nx">i</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span><span class="o">+</span><span class="s1">&#39;%&#39;</span><span class="o">+</span><span class="nx">j</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span><span class="p">)</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L32" class="lines-code chroma">
								<code>                    <span class="p">.</span><span class="nx">toUpperCase</span><span class="p">(</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L35" class="lines-code chroma">
								<code>        <span class="k">for</span><span class="p">(</span><span class="kd">var</span> <span class="nx">key</span> <span class="k">in</span> <span class="nx">U2Ghash</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L36" class="lines-code chroma">
								<code>            <span class="nx">G2Uhash</span><span class="p">[</span><span class="nx">U2Ghash</span><span class="p">[</span><span class="nx">key</span><span class="p">]</span><span class="p">]</span><span class="o">=</span><span class="nx">key</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L38" class="lines-code chroma">
								<code>    <span class="p">}</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L39" class="lines-code chroma">
								<code>    <span class="kd">function</span> <span class="nx">isAscii</span><span class="p">(</span><span class="nx">unicode</span><span class="p">)</span> <span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L40" class="lines-code chroma">
								<code>        <span class="k">return</span> <span class="p">(</span><span class="p">(</span><span class="nx">unicode</span> <span class="o">==</span> <span class="mh">0x20AC</span><span class="p">)</span> <span class="o">||</span> <span class="p">(</span><span class="nx">unicode</span> <span class="o">&lt;=</span> <span class="mh">0x007F</span> <span class="o">&amp;&amp;</span> <span class="nx">unicode</span> <span class="o">&gt;=</span> <span class="mh">0x0000</span><span class="p">)</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L43" class="lines-code chroma">
								<code>        <span class="nx">encode</span><span class="o">:</span><span class="kd">function</span><span class="p">(</span><span class="nx">str</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L44" class="lines-code chroma">
								<code>            <span class="k">return</span> <span class="nx">str</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/./g</span><span class="p">,</span><span class="kd">function</span><span class="p">(</span><span class="nx">a</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L45" class="lines-code chroma">
								<code>                <span class="kd">var</span> <span class="nx">code</span><span class="o">=</span><span class="nx">a</span><span class="p">.</span><span class="nx">charCodeAt</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L46" class="lines-code chroma">
								<code>                <span class="k">if</span><span class="p">(</span><span class="nx">isAscii</span><span class="p">(</span><span class="nx">code</span><span class="p">)</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L47" class="lines-code chroma">
								<code>                    <span class="k">return</span> <span class="nb">encodeURIComponent</span><span class="p">(</span><span class="nx">a</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L49" class="lines-code chroma">
								<code>                    <span class="kd">var</span> <span class="nx">key</span><span class="o">=</span><span class="nx">code</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L50" class="lines-code chroma">
								<code>                    <span class="k">if</span><span class="p">(</span><span class="nx">key</span><span class="p">.</span><span class="nx">length</span><span class="o">!=</span><span class="mi">4</span><span class="p">)</span><span class="nx">key</span><span class="o">=</span><span class="p">(</span><span class="s1">&#39;000&#39;</span><span class="o">+</span><span class="nx">key</span><span class="p">)</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="sr">/....$/</span><span class="p">)</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L51" class="lines-code chroma">
								<code>                    <span class="k">return</span> <span class="nx">U2Ghash</span><span class="p">[</span><span class="nx">key</span><span class="p">]</span><span class="o">||</span><span class="nx">a</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L55" class="lines-code chroma">
								<code>        <span class="nx">decode</span><span class="o">:</span><span class="kd">function</span><span class="p">(</span><span class="nx">str</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L56" class="lines-code chroma">
								<code>            <span class="k">return</span> <span class="nx">str</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/%[0-9A-F]{2}%[0-9A-F]{2}/g</span><span class="p">,</span><span class="kd">function</span><span class="p">(</span><span class="nx">a</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L57" class="lines-code chroma">
								<code>                <span class="k">if</span><span class="p">(</span><span class="nx">a</span> <span class="k">in</span> <span class="nx">G2Uhash</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L58" class="lines-code chroma">
								<code>                    <span class="k">return</span> <span class="nb">String</span><span class="p">.</span><span class="nx">fromCharCode</span><span class="p">(</span><span class="s1">&#39;0x&#39;</span><span class="o">+</span><span class="nx">G2Uhash</span><span class="p">[</span><span class="nx">a</span><span class="p">]</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L62" class="lines-code chroma">
								<code>            <span class="p">}</span><span class="p">)</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/%[\w]{2}/g</span><span class="p">,</span><span class="kd">function</span><span class="p">(</span><span class="nx">a</span><span class="p">)</span><span class="p">{</span></code>
							</td>
						</tr>
						...
						<tr>
							...
							<td rel="L63" class="lines-code chroma">
								<code>                <span class="k">return</span> <span class="nb">decodeURIComponent</span><span class="p">(</span><span class="nx">a</span><span class="p">)</span><span class="p">;</span></code>
							</td>
						</tr>
